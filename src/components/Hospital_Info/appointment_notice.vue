<template>
  <div class="appointment_notice">
    <div class="title">{{ hospitalDetail.hospital.hosname }}预约挂号须知</div>
    <div class="txt">为方便您早日就医康复，请您认真阅读预约挂号须知:</div>
    <div class="txtRed">一、预约实名制：</div>
    <div class="txt">
      统一平台电话预约和网上预约挂号均采取实名制注册预约，请您如实提供就诊人员的真实姓名、有效证件号（身份证、护照）、性别、手机号码、社保卡号等基本信息。
    </div>
    <div class="txtRed">二、预约挂号：</div>
    <div class="txt">
...
<script setup lang="ts" name="appointment_notice">
import useDetailStore from "@/store/modules/hospitalDetail";
import { storeToRefs } from "pinia";
let queryCancelStore = useDetailStore();
let { hospitalDetail } = storeToRefs(queryCancelStore);
</script>
